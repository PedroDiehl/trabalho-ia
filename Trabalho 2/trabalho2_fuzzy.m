...
listaRegras = [
    1 1 1 1 2; % Se o servico eh ruim ou a comida eh rancosa, então a gorjeta e baixa
    2 0 2 1 2; % Se o servico eh bom, então a gorjeta e media
    3 2 3 1 2  % Se o servico eh excelente ou a comida eh deliciosa, então a gorjeta e generosa
    ];
